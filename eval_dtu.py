...
def filter_depth(scan_folder, out_folder, plyfilename):
    ...
    for ref_view, src_views in pair_data:
        ...
        color = ref_img[:-16:step, ::step, :][valid_points]  # hardcoded for DTU dataset
...
if __name__ == '__main__':
    ...
    for scan in scans:
        ...
        filter_depth(scan_folder, out_folder, os.path.join(args.outdir, 'ply_{}x'.format(args.stage), 'mvsnet{:0>3}_l3.ply'.format(scan_id)))
